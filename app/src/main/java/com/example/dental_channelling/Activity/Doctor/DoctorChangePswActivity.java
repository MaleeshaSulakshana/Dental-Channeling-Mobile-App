...
public class DoctorChangePswActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_change_psw);
...
//    Hide status bar and navigation bar
    ...
    {
        Intent intent = new Intent(DoctorChangePswActivity.this, DoctorProfileActivity.class);
...
//       Check fields empty
        if (email.isEmpty() || psw.isEmpty() || newPsw.isEmpty() || newCPsw.isEmpty()) {
            Toast.makeText(DoctorChangePswActivity.this, "Text fields are empty!", Toast.LENGTH_SHORT).show();
                                ...
                                user.updatePassword(newPsw)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                if (task.isSuccessful()){
                                                    Toast.makeText(DoctorChangePswActivity.this, "Password Update Successful!", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    Toast.makeText(DoctorChangePswActivity.this, "Error" + msg, Toast.LENGTH_SHORT).show();
                                                }
