...
public class AdminViewAppointmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSelectDate = this.findViewById(R.id.btnSelectDate);
...
//        Onclick for show date picker
        btnSelectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(AdminViewAppointmentsActivity.this, date, calendar
        ...
        appointmentViewList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                Intent detailsPage = new Intent(AdminViewAppointmentsActivity.this, AdminViewAppointmentDetailsActivity.class);
...
//    Hide status bar and navigation bar
    ...
    private void goBack()
    {
        Intent intent = new Intent(AdminViewAppointmentsActivity.this, AdminDashboardActivity.class);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    ...
                    if (status.equals("pending") && appointmentDate.equals(dateSelected)) {
