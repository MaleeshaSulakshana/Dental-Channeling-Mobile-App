...
public class PatientPswChangeActivity extends AppCompatActivity {

    private Button btnCancel, btnChangePsw;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_psw_change);
...
//        Set onclick commands to back to profile view
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navigateToPatientProfileActivity();
            }
        });
...
//    Method for open profile dashboard activity
    private void navigateToPatientProfileActivity()
    {
        Intent intent = new Intent(PatientPswChangeActivity.this, PatientProfileActivity.class);
...
//       Check fields empty
        if (email.isEmpty() || psw.isEmpty() || newPsw.isEmpty() || newCPsw.isEmpty()) {
            Toast.makeText(PatientPswChangeActivity.this, "Text fields are empty!", Toast.LENGTH_SHORT).show();
                                ...
                                user.updatePassword(newPsw)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                if (task.isSuccessful()){
                                                    Toast.makeText(PatientPswChangeActivity.this, "Password Update Successful!", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    Toast.makeText(PatientPswChangeActivity.this, "Error" + msg, Toast.LENGTH_SHORT).show();
                                                }
