...
import com.example.dental_channelling.Activity.Patient.ChannellingActivity;
...
//        Onclick for show date picker
        btnSelectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(DoctorViewAppointmentsActivity.this, date, calendar
        ...
        appointmentViewList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                Intent detailsPage = new Intent(DoctorViewAppointmentsActivity.this, DoctorViewAppointmentsDetailsActivity.class);
...
//    Hide status bar and navigation bar
    ...
    private void goBack()
    {
        Intent intent = new Intent(DoctorViewAppointmentsActivity.this, DoctorDashboardActivity.class);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    ...
                    String appointmentUserId = snapshot1.child("doctorId").getValue().toString();
                    String status = snapshot1.child("status").getValue().toString();
                    String appointmentDate = snapshot1.child("date").getValue().toString();

                    if (doctorId.equals(appointmentUserId) && status.equals("pending")
